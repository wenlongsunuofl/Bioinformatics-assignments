 ...
 *
 */
public class GlobalLinear {
	ScoringMatrix scoreMat;
	public GlobalLinear(ScoringMatrix mat) {
		this.scoreMat = mat;
	}

	/**
	 * initialize the scoring matrix with linear gaps and populate. sequences
	 * @throws IOException 
	 */
